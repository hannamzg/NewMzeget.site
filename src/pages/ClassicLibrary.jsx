...
const ClassicLibrary = () => {
  ...
  // Classic library photos
  const classicLibraryPhotos = [
    '/photos/else/496926984_4007166902854923_3133161704785308882_n.jpg',
    '/photos/else/5b309f55-bb01-4e91-a6d0-8f8823685373.jpg'
  ];

  const nextSlide = () => {
    setCurrentSlide((prev) => (prev + 1) % classicLibraryPhotos.length);
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + classicLibraryPhotos.length) % classicLibraryPhotos.length);
  };
  ...
  const classicLibraryProjects = [
    {
      id: 1,
      title: "ספרייה קלאסית עם עץ כהה",
      description: "ספרייה קלאסית עם עץ אגוז כהה, מדפים מעוצבים ועיצוב מסורתי. מתאימה לסלון או חדר עבודה.",
      ...
      price: "35,000 ₪",
      features: ["עץ אגוז כהה", "מדפים מעוצבים", "עיצוב מסורתי", "פרטים קלאסיים"],
      location: "אבו סנאן 166"
    },
    {
      id: 2,
      title: "ספרייה קלאסית מלאה",
      description: "ספרייה קלאסית מלאה עם עץ כהה, מדפים מעוצבים ודלתות זכוכית. עיצוב מסורתי ואלגנטי.",
      image: '/photos/else/5b309f55-bb01-4e91-a6d0-8f8823685373.jpg',
      category: "ספריות",
      style: "קלאסי",
      materials: "עץ אגוז טבעי, זכוכית",
      dimensions: "4x2.5 מטר",
      price: "45,000 ₪",
      features: ["עץ כהה", "מדפים מעוצבים", "דלתות זכוכית", "עיצוב קלאסי"],
      location: "אבו סנאן 166"
    }
  ];
  ...
  return (
    <>
      <SEO 
        title="ספריות קלאסיות - אלי מזיגית נגרות"
        description="ספריות קלאסיות עם עיצוב מסורתי ואלגנטי. עץ אגוז כהה, מדפים מעוצבים ופרטים קלאסיים."
        url="https://elimazigit.com/storage/classic-library"
      />
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-xl text-neutral-600 mb-4 leading-relaxed">
              ספריות קלאסיות עם עיצוב מסורתי ואלגנטי. 
              עץ אגוז כהה, מדפים מעוצבים ופרטים קלאסיים עם חומרי גלם איכותיים.
            </p>
                        ...
                        <div className="relative overflow-hidden rounded-2xl">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                            <div className="flex items-center justify-between">
                              <div>
                                <h3 className="text-xl font-bold mb-1">ספרייה קלאסית #{index + 1}</h3>
                                <p className="text-sm opacity-90">לחץ להגדלה</p>
                              </div>
                              <div className="flex items-center space-x-2 space-x-reverse">
                                <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium">
                                  {index + 1} / {classicLibraryPhotos.length}
                                </span>
                  ...
                  <div className="flex items-center space-x-2 space-x-reverse">
                    ...
                    <div className="w-16 h-1 bg-white/30 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${((currentSlide + 1) / classicLibraryPhotos.length) * 100}%` }}
                      />
                    </div>
                    <span className="text-white text-sm font-medium">{classicLibraryPhotos.length}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Classic Library Features */}
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              מאפיינים של ספרייה קלאסית
            </h2>
            <p className="text-xl text-neutral-600">
              מה שהופך ספרייה לקלאסית ואלגנטית
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-neutral-600">מדפים מעוצבים עם עיצוב מסורתי ואלגנטי</p>
            </div>
      ...
      <section id="projects" className="section-padding bg-amber-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              פרויקטי ספריות קלאסיות
            </h2>
            <p className="text-xl text-neutral-600">
              {classicLibraryProjects.length} פרויקטים מעוצבים
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {classicLibraryProjects.map((project) => (
        ...
        <div className="container-custom">
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              מוכן לתכנן את הספרייה הקלאסית שלך?
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              קבל הצעת מחיר חינם ותתחיל ליצור את הספרייה הקלאסית המושלמת עבורך
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
