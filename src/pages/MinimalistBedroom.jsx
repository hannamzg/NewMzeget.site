...
const MinimalistBedroom = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [modalImage, setModalImage] = useState('');

  // Minimalist bedroom photos
  const minimalistBedroomPhotos = [
  ...
  const nextSlide = () => {
    setCurrentSlide((prev) => (prev + 1) % minimalistBedroomPhotos.length);
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + minimalistBedroomPhotos.length) % minimalistBedroomPhotos.length);
  };
  ...
  const minimalistBedroomProjects = [
    {
      id: 1,
      title: "חדר שינה מינימליסטי נקי",
      description: "חדר שינה מינימליסטי עם עיצוב נקי ופונקציונלי. מיטה פשוטה וארון מובנה.",
      ...
      dimensions: "4x3 מטר",
      price: "35,000 ₪",
      features: ["עיצוב נקי", "מיטה פשוטה", "ארון מובנה", "פונקציונליות"],
      location: "אבו סנאן 166"
    },
    {
      id: 2,
      title: "חדר שינה מינימליסטי מודרני",
      description: "חדר שינה מינימליסטי מודרני עם קווים נקיים ועיצוב פשוט. ארון מובנה ומיטה מינימליסטית.",
      ...
      price: "42,000 ₪",
      features: ["קווים נקיים", "ארון מובנה", "מיטה מינימליסטית", "עיצוב פשוט"],
      location: "אבו סנאן 166"
    }
  ];
  ...
  return (
    <>
      <SEO 
        title="חדרי שינה מינימליסטיים - אלי מזיגית נגרות"
        description="חדרי שינה מינימליסטיים עם עיצוב נקי ופונקציונלי. קווים נקיים, פשטות ואלגנטיות."
        url="https://elimazigit.com/bedrooms/minimalist"
      />
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-6">
              חדרי שינה מינימליסטיים
            </h1>
            <p className="text-xl text-neutral-600 mb-4 leading-relaxed">
              חדרי שינה מינימליסטיים עם עיצוב נקי ופונקציונלי. 
              קווים נקיים, פשטות ואלגנטיות עם חומרי גלם איכותיים.
            </p>
                        ...
                        <div className="relative overflow-hidden rounded-2xl">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                            <div className="flex items-center justify-between">
                              <div>
                                <h3 className="text-xl font-bold mb-1">חדר שינה מינימליסטי #{index + 1}</h3>
                                <p className="text-sm opacity-90">לחץ להגדלה</p>
                              </div>
                              <div className="flex items-center space-x-2 space-x-reverse">
                                <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium">
                                  {index + 1} / {minimalistBedroomPhotos.length}
                                </span>
                  ...
                  <div className="flex items-center space-x-2 space-x-reverse">
                    ...
                    <div className="w-16 h-1 bg-white/30 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${((currentSlide + 1) / minimalistBedroomPhotos.length) * 100}%` }}
                      />
                    </div>
                    <span className="text-white text-sm font-medium">{minimalistBedroomPhotos.length}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Minimalist Bedroom Features */}
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              מאפיינים של חדר שינה מינימליסטי
            </h2>
            <p className="text-xl text-neutral-600">
              מה שהופך חדר שינה למינימליסטי ונקי
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card p-6 text-center">
              ...
              <p className="text-neutral-600">קווים נקיים וישרים ללא עיטורים מיותרים</p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-neutral-600">עיצוב פשוט ונקי ללא אלמנטים מיותרים</p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-neutral-600">ארונות מובנים עם עיצוב נקי ופונקציונלי</p>
            </div>
      ...
      <section id="projects" className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              פרויקטי חדרי שינה מינימליסטיים
            </h2>
            <p className="text-xl text-neutral-600">
              {minimalistBedroomProjects.length} פרויקטים מעוצבים
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {minimalistBedroomProjects.map((project) => (
        ...
        <div className="container-custom">
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              מוכן לתכנן את חדר השינה המינימליסטי שלך?
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              קבל הצעת מחיר חינם ותתחיל ליצור את חדר השינה המינימליסטי המושלם עבורך
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
