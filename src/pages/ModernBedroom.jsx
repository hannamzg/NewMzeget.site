...
const ModernBedroom = () => {
  ...
  // Modern bedroom photos
  const modernBedroomPhotos = [
  ...
  const nextSlide = () => {
    setCurrentSlide((prev) => (prev + 1) % modernBedroomPhotos.length);
  };

  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 1 + modernBedroomPhotos.length) % modernBedroomPhotos.length);
  };
  ...
  const modernBedroomProjects = [
    {
      id: 1,
      title: "חדר שינה מודרני עם ארון מובנה",
      description: "חדר שינה מודרני עם ארון מובנה, מיטה מעוצבת וקומפלט שינה מלא. עיצוב נקי ופונקציונלי.",
      image: '/photos/beedrooms/12d28fa7-d693-4c43-b814-70e81bb2013f.jpg',
      category: "חדרי שינה",
      style: "מודרני",
      materials: "MDF מצופה למינציה, עץ",
      dimensions: "4x3 מטר",
      price: "45,000 ₪",
      features: ["ארון מובנה", "מיטה מעוצבת", "קומפלט שינה", "תאורה מובנית"],
      location: "אבו סנאן 166"
    },
    {
      id: 2,
      title: "חדר שינה מודרני עם שידות",
      description: "חדר שינה מודרני עם שידות מעוצבות, ארון מובנה ומיטה מודרנית. עיצוב נקי ואלגנטי.",
      ...
      price: "52,000 ₪",
      features: ["שידות מעוצבות", "ארון מובנה", "מיטה מודרנית", "עיצוב נקי"],
      location: "אבו סנאן 166"
    },
    {
      id: 3,
      title: "חדר שינה מודרני מלא",
      description: "חדר שינה מודרני מלא עם כל הרהיטים - מיטה, ארון, שידות וקומפלט שינה. עיצוב מודרני ופונקציונלי.",
      ...
      dimensions: "5x4 מטר",
      price: "65,000 ₪",
      features: ["מיטה מעוצבת", "ארון מובנה", "שידות", "קומפלט שינה"],
      location: "אבו סנאן 166"
    }
  ];
  ...
  return (
    <>
      <SEO 
        title="חדרי שינה מודרניים - אלי מזיגית נגרות"
        description="חדרי שינה מודרניים עם עיצוב נקי ופונקציונלי. ארונות מובנים, מיטות מעוצבות וקומפלטי שינה מלאים."
        url="https://elimazigit.com/bedrooms/modern"
      />
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-xl text-neutral-600 mb-4 leading-relaxed">
              חדרי שינה מודרניים עם עיצוב נקי ופונקציונלי. 
              ארונות מובנים, מיטות מעוצבות וקומפלטי שינה מלאים עם חומרי גלם איכותיים.
            </p>
                        ...
                        <div className="relative overflow-hidden rounded-2xl">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                            <div className="flex items-center justify-between">
                              <div>
                                <h3 className="text-xl font-bold mb-1">חדר שינה מודרני #{index + 1}</h3>
                                <p className="text-sm opacity-90">לחץ להגדלה</p>
                              </div>
                              <div className="flex items-center space-x-2 space-x-reverse">
                                <span className="bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium">
                                  {index + 1} / {modernBedroomPhotos.length}
                                </span>
                  ...
                  <div className="flex items-center space-x-2 space-x-reverse">
                    ...
                    <div className="w-16 h-1 bg-white/30 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ width: `${((currentSlide + 1) / modernBedroomPhotos.length) * 100}%` }}
                      />
                    </div>
                    <span className="text-white text-sm font-medium">{modernBedroomPhotos.length}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Modern Bedroom Features */}
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              מאפיינים של חדר שינה מודרני
            </h2>
            <p className="text-xl text-neutral-600">
              מה שהופך חדר שינה למודרני ונוח
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card p-6 text-center">
              ...
              <p className="text-neutral-600">עיצוב מינימליסטי עם קווים נקיים וללא עיטורים מיותרים</p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-neutral-600">ארונות מובנים שמנצלים את החלל בצורה מקסימלית</p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">נוחות מקסימלית</h3>
              <p className="text-neutral-600">עיצוב שמתמקד בנוחות ובשינה איכותית</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              פרויקטי חדרי שינה מודרניים
            </h2>
            <p className="text-xl text-neutral-600">
              {modernBedroomProjects.length} פרויקטים מעוצבים
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {modernBedroomProjects.map((project) => (
        ...
        <div className="container-custom">
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              מוכן לתכנן את חדר השינה המודרני שלך?
            </h2>
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              קבל הצעת מחיר חינם ותתחיל ליצור את חדר השינה המודרני המושלם עבורך
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
